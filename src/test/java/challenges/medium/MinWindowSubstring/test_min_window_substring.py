from src.main.java.challenges.medium.MinWindowSubstring.someone_elses import MinWindowSubstring1
from src.main.java.challenges.medium.MinWindowSubstring.solution_min_window_substring import MinWindowSubstring
import pytest
...
@pytest.mark.parametrize("input_array,expected_result", test_data)
def test_min_window_substring_someone_elses(input_array: List[str], expected_result: str):
